...
class Main{
    public static void main(String args[]) {
        try{
            ...
            Connection connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/jdbc_check", "root", "root");
            ...
            while(choice == 1 || choice == 2 || choice ==3 || choice == 4) {
                switch(choice) {
                        ...
                        while (choice2 == 1 || choice2 == 2 || choice == 3) {
                            switch (choice2) {
                                ...
                                case 3:
                                    ...
                                    System.out.println("Where you want to update(sno)");
                                    int f = sc.nextInt();
                                    st.executeUpdate("update student set DEPARTMENT = '" + e + "' where SNO = " + f);
                                    break;
                            }
                    ...
                    case 3:
                        ...
                        String query = "insert into student (SNO, NAME, DEPARTMENT) values (" + sno1 + ", '" + name1 + "','" + DEPARTMENT1 + "')";
